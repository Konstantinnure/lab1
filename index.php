        ...
        switch ($key) {
            ...
            case 'date_from':
                ...
                foreach ($model->get_literature_by_date($value, $_GET['date_to']) as $el) {
                    echo '<tr>';
                    echo '<td>' . $el['name'] . '</td><td>' . (isset($el['date']) ? date('d.m.Y', strtotime($el['date'])) : '') . '</td><td>' . $el['year'] . '</td><td>' . $el['publisher'] . '</td><td>' . $el['quantity'] . '</td><td>' . $el['isbn'] . '</td><td>' . $el['number'] . '</td><td>' . $el['literate'] . '</td><td>' . $model->get_recource($el['idResource'])['title'] . '</td>';
                    echo '</tr>';
                }
                echo '</table>';
                break;
